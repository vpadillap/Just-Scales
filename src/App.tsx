      ...
      <div className="h-screen w-full flex flex-col bg-surface-base overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-h-0 overflow-hidden relative">
          <div className="w-full h-full px-4 md:px-8 pt-4 pb-4 flex flex-col min-h-0 overflow-y-auto custom-scrollbar">
            {/* Scale Selector */}
            <div className="mb-4 flex justify-center space-x-2 overflow-x-auto pb-2 no-scrollbar shrink-0">
        ...
        <div className="shrink-0 border-t border-surface-mid bg-surface-base z-10 w-full max-w-full">
          <PianoVisualizer />
        </div>
