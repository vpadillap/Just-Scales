...
### UI Architecture
- **Scale Creator**: A visually appealing and easy-to-use interface with a visual representation of the note sequence. Users can add "events" (Note or Rest) in order.
